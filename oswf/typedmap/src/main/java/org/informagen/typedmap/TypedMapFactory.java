    ...
    public static TypedMapFactory getInstance() {
        ...
        if(instance == null) 
            instance = new TypedMapFactory()
                // .addNamedTypedMap("aggregate", "org.informagen.typedmap.AggregateTypedMap")
                // .addNamedTypedMap("proxy", "org.informagen.typedmap.ProxyTypedMap")
                // .addNamedTypedMap("bean", "org.informagen.typedmap.BeanTypedMap")
                // .addNamedTypedMap("map", "org.informagen.typedmap.MapTypedMap")
                .addNamedTypedMap("memory", "org.informagen.typedmap.MemoryTypedMap")
                // .addNamedTypedMap("serializable", "org.informagen.typedmap.SerializableTypedMap")
                // .addNamedTypedMap("xml", "org.informagen.typedmap.XMLTypedMap")
            ;            
