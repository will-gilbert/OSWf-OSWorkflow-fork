...
import org.informagen.oswf.typedmap.*;
...
public class JDBCTypedMap extends AbstractTypedMap {
    ...
    public JDBCTypedMap(Map<String,String> parameters, Map<String,Object>args) {
    ...
    public Collection<String> getKeys(String prefix, Type type) throws TypedMapException {
        ...
        try {
            ...
            throw new TypedMapException(e.getMessage());
        } finally {
            cleanup(conn, ps, rs);
        }
    }

    public Type getType(String key) throws TypedMapException {
    ...
    public boolean exists(String key) throws TypedMapException {
    ...
    public void remove(String key) throws TypedMapException {
        Connection conn = null;
        PreparedStatement ps = null;
    ...
    protected void setImpl(Type type, String key, Object value) throws TypedMapException {
        
        if (value == null) 
            throw new TypedMapException("JDBCTypedMap does not allow for null values to be stored");
    ...
    protected Object get(Type type, String key) throws TypedMapException {
            ...
            if (rs.next()) {
                ...
                case OBJECT:
                    ...
                    try {
                        ...
                        throw new TypedMapException("Error de-serializing object for key '" + key + "' from store:" + e);
                ...
                default:
                    throw new InvalidValueTypeException("JDBCTypedMap doesn't support this type yet.");
                }
            }
        } catch (SQLException e) {
            throw new TypedMapException(e.getMessage());
    ...
    private void setValues(PreparedStatement ps, Type type, String key, Object value) throws SQLException, TypedMapException {
        ...
        case OBJECT:
            ...
            if (!(value instanceof Serializable)) {
                throw new TypedMapException(value.getClass() + " does not implement java.io.Serializable");
            }
            ...
            try {
                ...
                throw new TypedMapException("I/O Error when serializing object:" + e);
            }
        ...
        default:
            throw new TypedMapException("This type isn't supported!");
        }
    }
