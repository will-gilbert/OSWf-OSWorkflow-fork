 ...
 *
 */
public abstract class AbstractPersistentVars implements PersistentVars {

    protected static final Logger log = LoggerFactory.getLogger("org.informagen.oswf.AbstractPersistentVars");


    // A B S T R A C T   M E T H O D S  -------------------------------------------------------

    public abstract boolean exists(String key) throws PersistentVarsException;
    
    public abstract void remove() throws PersistentVarsException;

    public abstract Type getType(String key) throws PersistentVarsException;

    protected abstract void setImpl(Type type, String key, Object value) throws PersistentVarsException;

    protected abstract Object get(Type type, String key) throws PersistentVarsException;
    
    // M E T H O D S  -------------------------------------------------------------------------

    public void setAsActualType(String key, Object value) throws PersistentVarsException {
    ...
    public Object getAsActualType(String key) throws PersistentVarsException {
    ...
    /**
     * Constructs {@link org.informagen.oswf.util.ByteArray} wrapper around bytes.
     */
    ...
    /**
     * Casts to {@link org.informagen.oswf.util.ByteArray} and returns bytes.
     */
     ...
     */
    public Collection<String> getKeys() throws PersistentVarsException {
     ...
     */
    public Collection<String> getKeys(Type type) throws PersistentVarsException {
     ...
     */
    public Collection<String> getKeys(String prefix) throws PersistentVarsException {
    ...
    /**
     * Throws IllegalValueException if value length greater than 255.
     */
    public void setString(String key, String value) {
        if ((value != null) && (value.length() > 255)) {
            throw new IllegalValueException("String exceeds 255 characters.");
        }
    ...
    private void set(Type type, String key, Object value) throws PersistentVarsException {
