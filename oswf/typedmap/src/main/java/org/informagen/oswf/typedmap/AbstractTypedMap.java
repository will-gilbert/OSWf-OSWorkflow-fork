...
public abstract class AbstractTypedMap implements TypedMap {
    ...
    protected static final Logger log = LoggerFactory.getLogger("org.informagen.oswf.typedmap");


    // A B S T R A C T   M E T H O D S  -------------------------------------------------------

    public abstract boolean exists(String key) throws TypedMapException;
    
    public abstract void remove() throws TypedMapException;

    public abstract Type getType(String key) throws TypedMapException;

    protected abstract void setImpl(Type type, String key, Object value) throws TypedMapException;

    protected abstract Object get(Type type, String key) throws TypedMapException;
    
    // M E T H O D S  -------------------------------------------------------------------------

    public void setAsActualType(String key, Object value) throws TypedMapException {
    ...
    public Object getAsActualType(String key) throws TypedMapException {
    ...
    /**
     * Constructs {@link org.informagen.oswf.typedmap.util.ByteArray} wrapper around bytes.
     */
    ...
    /**
     * Casts to {@link org.informagen.oswf.typedmap.util.ByteArray} and returns bytes.
     */
     ...
     */
    public Collection<String> getKeys() throws TypedMapException {
     ...
     */
    public Collection<String> getKeys(Type type) throws TypedMapException {
     ...
     */
    public Collection<String> getKeys(String prefix) throws TypedMapException {
    ...
    private void set(Type type, String key, Object value) throws TypedMapException {
