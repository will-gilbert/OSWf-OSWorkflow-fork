...
public class JDBCPersistentVars extends AbstractPersistentVars {
    ...
    public JDBCPersistentVars() {}

    public JDBCPersistentVars(Map<String,String> parameters, Map<String,Object>args) {
    ...
    public Collection<String> getKeys(String prefix, Type type) throws PersistentVarsException {
        ...
        try {
            ...
            throw new PersistentVarsException(e.getMessage());
        } finally {
            cleanup(conn, ps, rs);
        }
    }

    public Type getType(String key) throws PersistentVarsException {
    ...
    public boolean exists(String key) throws PersistentVarsException {
    ...
    public void remove(String key) throws PersistentVarsException {
        Connection conn = null;
        PreparedStatement ps = null;
    ...
    protected void setImpl(Type type, String key, Object value) throws PersistentVarsException {
        
        if (value == null) 
            throw new PersistentVarsException("JDBCPersistentVars does not allow for null values to be stored");
    ...
    protected Object get(Type type, String key) throws PersistentVarsException {
            ...
            if (rs.next()) {
                ...
                case OBJECT:
                    ...
                    try {
                        ...
                        throw new PersistentVarsException("Error de-serializing object for key '" + key + "' from store:" + e);
                ...
                default:
                    throw new InvalidValueTypeException("JDBCPersistentVars doesn't support this type yet.");
                }
            }
        } catch (SQLException e) {
            throw new PersistentVarsException(e.getMessage());
    ...
    private void setValues(PreparedStatement ps, Type type, String key, Object value) throws SQLException, PersistentVarsException {
        ...
        case OBJECT:
            ...
            if (!(value instanceof Serializable)) {
                throw new PersistentVarsException(value.getClass() + " does not implement java.io.Serializable");
            }
            ...
            try {
                ...
                throw new PersistentVarsException("I/O Error when serializing object:" + e);
            }
        ...
        default:
            throw new PersistentVarsException("This type isn't supported!");
        }
    }
