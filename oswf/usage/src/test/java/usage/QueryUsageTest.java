...
/**
 * This test case is desinged to gain some understanding of OSWf's
 *   implementation of security and maybe create some notion of a swimlane.
 *
...
public class QueryUsageTest extends OSWfTestCase implements Constants {
    ...
    public void setUp() throws Exception {
        ...
        janeEngine = new DefaultOSWfEngine("jane.doe");
        janeEngine.setConfiguration(config);
    }
    ...
    public void entryByName() throws Exception {
        ...
        janeEngine.initialize("Holiday", INITIAL_ACTION);
    ...
    public void currentStepsByOwner() throws Exception {
        ...
        assertEquals(0, wfEngine.query(query).size());
        assertEquals(0, janeEngine.query(query).size());
    ...
    public void historyStepsByOwner() throws Exception {
        ...
        current = new FieldExpression(
            Context.CURRENT_STEPS,
            Field.OWNER, Operator.EQUALS, "test"
        );
                                         
        history = new FieldExpression(
    ...
    public void suspendedState() throws Exception {
        ...
        active = new FieldExpression(
            Context.ENTRY, 
            Field.STATE, Operator.EQUALS, ProcessInstanceState.ACTIVE
        );
        
        suspended = new FieldExpression(
            Context.ENTRY, 
