...
public class JoinBugTest {
    ...
    public JoinBugTest() {
        logger = LoggerFactory.getLogger("usage.JoinBugTest");
    }

    @Before
    public void setup() throws Exception {
        wfEngine = new DefaultOSWfEngine("JoinBugTest");
    }
    ...
    private void checkRoute(int[] actions)  {
        ...
        try {
            long workflowId = wfEngine.initialize(getClass().getResource("/usage/LeaveRequest.oswf.xml").toString(), 1, null);
