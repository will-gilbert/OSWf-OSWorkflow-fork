...
public class BeanShellConditionsTest {
    ...
    public void nestedCondition() throws Exception {
        ...
        def url = getClass().getResource("/core/beanshell/nested-condition.oswf.xml")
    ...
    public void orCondition() throws Exception {
        def url = getClass().getResource("/core/beanshell/boolean-conditions.oswf.xml")
        def piid = wfEngine.initialize(url.toString(), 1)
