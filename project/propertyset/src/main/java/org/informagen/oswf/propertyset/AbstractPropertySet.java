...
public abstract class AbstractPropertySet implements PropertySet {
    ...
    protected static final Logger log = LoggerFactory.getLogger("org.informagen.oswf.propertyset");
    ...
    /**
     * Constructs {@link org.informagen.oswf.propertyset.util.ByteArray} wrapper around bytes.
     */
    ...
    /**
     * Casts to {@link org.informagen.oswf.propertyset.util.ByteArray} and returns bytes.
     */
