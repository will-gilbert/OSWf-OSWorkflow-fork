...
public class HibernatePropertySetItem implements Serializable {
    ...
    public HibernatePropertySetItem() {}

	
    public HibernatePropertySetItem(Long piid, String key) {
        this.piid = piid;
        this.key = key;
    }
    public HibernatePropertySetItem(Long piid, String key, int type, String stringVal, Integer intVal, Double doubleVal, Long longVal, String textVal) {
       this.piid = piid;
       this.key = key;
       this.type = type;
