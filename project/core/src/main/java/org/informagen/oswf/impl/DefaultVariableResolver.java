...
public class DefaultVariableResolver implements VariableResolver, Serializable {
    ...
    public Object getVariableFromMaps(String var, Map<String,Object> transientVars, PropertySet ps) {
        ...
        // If not found, the check the PropertySet; beware that HibernatePropertySet
