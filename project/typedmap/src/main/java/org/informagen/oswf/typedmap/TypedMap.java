...
public interface TypedMap {
    ...
    void setAsActualType(String key, Object value) throws TypedMapException;
    Object getAsActualType(String key) throws TypedMapException;

    void setBoolean(String key, boolean value) throws TypedMapException;
    boolean getBoolean(String key) throws TypedMapException;

    void setData(String key, byte[] value) throws TypedMapException;
    byte[] getData(String key) throws TypedMapException;

    void setDate(String key, Date value) throws TypedMapException;
    Date getDate(String key) throws TypedMapException;

    void setDouble(String key, double value) throws TypedMapException;
    double getDouble(String key) throws TypedMapException;

    void setInt(String key, int value) throws TypedMapException;
    int getInt(String key) throws TypedMapException;

    void setLong(String key, long value) throws TypedMapException;
    long getLong(String key) throws TypedMapException;

    void setObject(String key, Object value) throws TypedMapException;
    Object getObject(String key) throws TypedMapException;

    void setProperties(String key, Properties value) throws TypedMapException;
    Properties getProperties(String key) throws TypedMapException;

    void setString(String key, String value) throws TypedMapException;
    String getString(String key) throws TypedMapException;

    void setText(String key, String value) throws TypedMapException;
    String getText(String key) throws TypedMapException;

    void setXML(String key, Document value) throws TypedMapException;
    Document getXML(String key) throws TypedMapException;
    ...
    * Removes property.
    */
    void remove(String key) throws TypedMapException;

    /**
     * Remove the propertyset and all it associated keys.
     * @throws TypedMapException if there is an error removing the propertyset.
     */
    void remove() throws TypedMapException;
    ...
    */
    ...
    Collection<String> getKeys() throws TypedMapException;
    ...
    * @return Unmodifiable {@link java.util.Collection} of {@link java.lang.String}s.
    */
    Collection<String> getKeys(Type type) throws TypedMapException;
    ...
    * @return Unmodifiable {@link java.util.Collection} of {@link java.lang.String}s.
    */
    Collection<String> getKeys(String prefix) throws TypedMapException;
    ...
    */
    Collection<String> getKeys(String prefix, Type type) throws TypedMapException;
    ...
    */
    ...
    Type getType(String key) throws TypedMapException;

    /**
    * Determine if property exists.
    */
    boolean exists(String key) throws TypedMapException;
